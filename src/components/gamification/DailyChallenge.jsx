...
export default function DailyChallenge({ 
  ...
  return (
    <div className={`rounded-2xl p-4 shadow-lg border ${isDark ? 'bg-[#12121a] border-white/10' : 'bg-white border-purple-100'}`}>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1">
                    <p className={`text-sm font-medium ${complete ? isDark ? 'text-emerald-400 line-through' : 'text-emerald-800 line-through' : isDark ? 'text-slate-200' : 'text-slate-700'}`}>
                      {challenge.title}
                    </p>
                  ...
                  {!complete && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`text-[10px] ${isDark ? 'text-slate-500' : 'text-slate-500'}`}>{progress}/{challenge.target}</span>
                    </div>
                  )}
                </div>
              </div>

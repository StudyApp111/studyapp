    ...
    <div className="fixed inset-0 z-[99999] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="p-6 space-y-4">
          {/* Social in-app browser: completely gate auth buttons */}
          {isSocialInApp ? (
            <InAppBrowserGate
              title="Open in your browser to sign up"
              subtitle="This app browser doesn't support sign in. Open in Safari or Chrome — your lesson will be waiting!"
            />
          ) : (
            <>
              {/* Sign-in buttons — only shown in real browsers */}

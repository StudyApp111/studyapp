...
export default function EditableNoteContent({ content, onSave, isDark, toolbarActions = null }) {
  ...
  return (
    <div ref={containerRef} className={`turbo-editor ${isDark ? "dark" : ""}`}>
      <style>{`
        .turbo-editor { position: relative; max-width: 100%; }
        ...
        @media (max-width: 640px) {
          ...
          .turbo-editor .ql-toolbar.ql-snow::-webkit-scrollbar { display: none; }
        ...
        .turbo-editor .ql-editor h1 { font-size: 2rem; font-weight: 800; margin: 1.5rem 0 1rem; border-bottom: 1px solid ${isDark ? "rgba(255,255,255,0.1)" : "rgb(226 232 240)"}; padding-bottom: .5rem; line-height: 1.25; }
        .turbo-editor .ql-editor h2 { font-size: 1.5rem; font-weight: 700; margin: 1.75rem 0 .75rem; color: ${isDark ? "#c4b5fd" : "#7c3aed"}; line-height: 1.3; }
        .turbo-editor .ql-editor h3 { font-size: 1.15rem; font-weight: 600; margin: 1.25rem 0 .5rem; line-height: 1.35; }
        /* Mobile: tighter padding + smaller headings — fixes the giant H1 stacking issue */
        @media (max-width: 640px) {
          .turbo-editor .ql-editor {
            padding: 16px 12px;
            font-size: 15px;
          ...
          .turbo-editor .ql-editor h1 { font-size: 1.35rem; margin: 1rem 0 .5rem; padding-bottom: .35rem; }
          .turbo-editor .ql-editor h2 { font-size: 1.1rem; margin: 1rem 0 .35rem; }
          .turbo-editor .ql-editor h3 { font-size: 1rem; margin: .75rem 0 .35rem; }
          .turbo-editor .ql-editor table { display: block; overflow-x: auto; }
        }

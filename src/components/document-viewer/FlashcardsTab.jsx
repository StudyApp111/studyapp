...
export default function FlashcardsTab({ lesson, extractedContent, focusTopics, isVisible = false }) {
  ...
  // Only load flashcards when tab becomes visible AND hasn't loaded yet
  useEffect(() => {

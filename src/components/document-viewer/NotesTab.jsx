...
import { Loader2, Settings2, RefreshCw, Copy, Check, Zap, Sparkles, BookOpen, GraduationCap, FileText, Download, Notebook, ChevronLeft, ChevronRight as ChevronRightIcon, Headphones } from "lucide-react";
...
export default function NotesTab({ lesson }) {
  ...
  // Uses a module-level Set so re-mounts (tab switches, route changes) cannot
  // re-fire generation and cause API rate-limit storms (429s).
  ...
  useEffect(() => {
    ...
    // No cleanup — we intentionally keep the lock until full page reload.

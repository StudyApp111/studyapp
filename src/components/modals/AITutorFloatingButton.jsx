    ...
    <>
      ...
      >
        <Button
          ...
          className="h-12 px-4 rounded-full shadow-2xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white transition-all hover:scale-105 gap-2"
        >
      ...
      >
        <Button
          onClick={() => setIsOpen(true)}
          size="sm"
          className="h-10 w-10 rounded-full shadow-lg bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 p-0"
        >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 left-8 z-50 hidden md:block"
          >
            <div className="w-96 h-[500px] bg-white rounded-2xl shadow-2xl border border-purple-200 flex flex-col overflow-hidden">
              {/* Header */}

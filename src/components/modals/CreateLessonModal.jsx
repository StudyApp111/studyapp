...
export default function CreateLessonModal({ open, onOpenChange }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Background: Create empty Exam 1 entity only (ExamTab handles generation)
      (async () => {
        try {
          ...
          console.log("✅ Empty Exam 1 entity created");
        } catch (err) {
          console.error("❌ Error creating exam entity:", err);
        }
      })();

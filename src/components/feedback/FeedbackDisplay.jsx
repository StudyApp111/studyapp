  ...
  return (
    <div className={`space-y-6 px-3 max-w-5xl mx-auto ${isDark ? 'bg-[#0a0a12]' : ''}`}>
      ...
      >
        ...
        {/* CTA: View Study Plan - right below confidence */}
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <button
            onClick={() => window.dispatchEvent(new CustomEvent('switchToStudyPlanTab'))}
            className="w-full max-w-md mx-auto px-5 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 shadow-xl shadow-emerald-500/25 transition-all group flex items-center justify-between"
          >
            <p className="text-white font-bold text-lg">Next Step: View Your Custom Study Plan</p>
            <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center group-hover:translate-x-1 transition-transform flex-shrink-0 ml-3">
